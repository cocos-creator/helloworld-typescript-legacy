	...
	*/
	...
	export enum Macro {		
		...
		*/
		...
		``` 
		*/
		loadResArray(urls : String[], type? : Function, progressCallback? : Function, completeCallback: (error: Error, assets: Asset[]|any[]) => void) : void;		
		...
		``` 
		*/
		loadResDir(url : string, type? : Function, progressCallback? : Function, completeCallback: (error: Error, assets: Asset[]|any[], urls: String[]) => void) : void;		
...
declare module cc._decorator {	
	...
	``` 
	*/
	export function ccclass(name? : any) : void;
	/** !#en
	...
	*/
    ...
    export function property(options? : ICCProperty) : any;
    /** !#en
	...
	``` 
	*/
	export function executeInEditMode(cls: any) : void;
	/** !#en
	...
	``` 
	*/
	export function requireComponent(requiredComponent : any) : any;
	/** !#en
	...
	``` 
	*/
	export function menu(path : string) : any;
	/** !#en
	...
	``` 
	*/
	export function executionOrder(order : number) : any;
	/** !#en
	...
	``` 
	*/
	export function disallowMultiple(cls: any) : void;
	/** !#en
	...
	``` 
	*/
	export function playOnFocus(cls: any) : void;
	/** !#en
	...
	``` 
	*/
	export function inspector(url : string) : any;
	/** !#en
	...
	``` 
	*/
	export function help(url : string) : any;
	/** NOTE:<br>
	...
	``` 
	*/
	export function mixins(ctor : Function) : any;
}
